...
<body>
    ...
    <section style="height: 100px;"><button class="btn btn-primary" type="button" style="margin-left: 383px;margin-top: 32px;width: 300px;font-family: Alata, sans-serif;font-weight: bold;background: var(--bs-orange);">Supervisors List</button></section>
    ...
    echo "<tr>";
          ...
          echo  "<td>$row[0]</td>"; 
           ...
           echo  "<td>$row[3]</td>"; 
            ...
            echo '<td ><a class="bn" style="width:200px;" href="supsess.php?username=';
            echo $row[0];
