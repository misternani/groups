...
<body>
    ...
    <section class="d-grid" style="background: #ffffff;height: 500px;width: 1000px;padding-left: 0px;margin-left: 285px;position: relative;display: grid;margin-top: 1px;border-color: var(--bs-pink);">
        <ul class="list-unstyled" style="margin-left: 88px;width: 400px;border-color: rgb(211,230,250);">
            ...
            <li class="text-start" style="color: rgb(255,214,0);"><button class="btn btn-primary text-center" type="button" style="background: var(--bs-yellow);font-weight: bold;font-size: 20px;width: 200px;font-family: Alata, sans-serif;">GroupsList</button></li></ul>

            <table style="width: 600px;height: 50px;position: static;margin-left: 88px;margin-top: -150px;border-radius: 10px;">
                <tr>
                    <th>GroupName</th>
                    <th>TopicName</th>
                    <th>CreatorName</th>
...
$sql="SELECT groupname,creatorname FROM grouplist";
