...
<body>
    <div id="sidebar-wrapper-1" style="color: rgb(130,69,69);background: rgb(255,255,255);height: 700px;position: fixed;width: 300px;margin-left: 1px;">
    ...
    <section class="position-relative py-4 py-xl-5" style="margin-left: 147px;margin-top: 7px;">
        <div class="container position-relative">
            <div class="row d-flex justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-weight: bold;font-family: Alata, sans-serif;">Add Student</h2>
                            <form method="post" action="addstu.php">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="username" placeholder="Username" required></div>
                                <div class="mb-3"><input class="form-control" type="email" id="email-2" name="email" placeholder="Email" required><input class="form-control" type="text" id="email-1" name="password" placeholder="Password" style="margin-top: 24px;" required></div>
                                <div class="mb-3"></div>
    ...
    <div id="wrapper-1" style="color: var(--bs-pink);width: 300px;height: 0px;"></div>
