                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5" style="padding-bottom: 0px;margin-bottom: 40px;">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-weight: bold;font-family: Alata, sans-serif;">Add Topic</h2>
                            <form method="post" action="addtop.php">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="topic" placeholder="Topic Name" required></div>
                                <div class="mb-3"></div>
                                <div class="mb-3"></div>
