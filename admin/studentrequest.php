...
<body>
    ...
    <section style="height: 100px;"><button class="btn btn-primary" type="button" style="margin-top: 32px;width: 250px;font-family: Alata, sans-serif;font-weight: bold;background: var(--bs-teal);margin-left: 305px;">Requests by Students</button></section>
 ...
 while ($row = mysqli_fetch_row($result))
 {
   ...
   echo "<tr>";
          ...
          echo  "<td>$row[0]</td>"; 
            ...
            echo '<form method="post" action="sturequest.php">';
           echo  "<td>";
           echo '<select class="form-select" style="margin-top: 15px;color: var(--bs-gray-600);" name="topic">';
