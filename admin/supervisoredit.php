                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5" style="padding-bottom: 0px;margin-bottom: 40px;">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-weight: bold;font-family: Alata, sans-serif;">Supervisor Details</h2>
                            <form method="post" action="supedit.php">
                                <div class="mb-3">
                                     <label style="color: gray;font-weight: medium;">Username:</label> <?php
include('connect.php');
...
$sql="SELECT email FROM supervisor WHERE username='".$uname."' limit 1";
$result = $conn->query($sql);
...
$sql="SELECT password FROM supervisor WHERE username='".$uname."' limit 1";
$result = $conn->query($sql);
...
?>  
                                ...
                                <select class="form-select" style="margin-top: 20px;" name="topic">
                                      <?php
include('connect.php');
...
$sql="SELECT topicname FROM supervisor WHERE username='".$uname."' limit 1";
$result = $conn->query($sql);
