            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5" style="border-width: 0px;">
                        <div class="card-body p-sm-5" style="width: 600px;margin-left: 34px;">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-family: Alata, sans-serif;font-weight: bold;">Change Password</h2>
                            <form method="post" action="changepas.php">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="oldpassword" placeholder="Enter old password"required></div>
                                <div class="mb-3"><input class="form-control" type="text" id="email-2" name="newpassword" placeholder="Enter new password" required></div>
                                <div class="mb-3"></div>
