...
<body>
    ...
    <section class="d-grid" style="background: #ffffff;height: 500px;width: 1000px;padding-left: 0px;margin-left: 285px;position: relative;display: grid;margin-top: 1px;border-color: var(--bs-pink);">
        <ul class="list-unstyled" style="margin-left: 88px;width: 400px;">
            ...
            <li class="text-start" style="color: rgb(255,214,0);"><button class="btn btn-primary text-center" type="button" style="background: var(--bs-orange);font-weight: bold;font-size: 20px;width: 200px;">Topic Assigned</button></li>
            <li class="text-start" style="color: rgb(187,208,228);font-weight: bold;font-size: 25px;">
               <?php
session_start();
include('connect.php');
...
$sql="SELECT topicname FROM topiclist where supervisorname='".$uname."' limit 1";
