...
<body>
    ...
    <section class="position-relative py-4 py-xl-5" style="width: 2000px;margin-left: -126px;">
        <div class="container position-relative">
            <div class="row d-flex justify-content-center" style="margin-top: 68px;margin-left: 77px;">
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5" style="margin-left: -1px;">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-family: Alata, sans-serif;font-weight: bold;">Request Topic Change</h2>
                            <form method="post" action="request.php">
                                <div class="mb-3"></div><select class="form-select" name="topic">
           <?php
include('connect.php');
