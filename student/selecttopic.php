                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4" style="color: var(--bs-blue);font-family: Alata, sans-serif;font-weight: bold;">Request Topic</h2>
                            <form method="post" action="top.php">
                                <div class="mb-3"></div>
                                <label style="color: gray;font-weight: medium;">Preference1:</label>
                                <select class="form-select" name="preference1">
                                                                   <?php
include('connect.php');
...
?>  
                                 ...
                                 <label style="color: gray;font-weight: medium;">Preference2:</label>
                                <select class="form-select" name="preference2">
                                                                   <?php
include('connect.php');
...
?>  
                                 ...
                                 <label style="color: gray;font-weight: medium;">Preference3:</label>
                                <select class="form-select" name="preference3">
                                                                   <?php
include('connect.php');
...
?>  
                                 ...
                                 <label style="color: gray;font-weight: medium;">Preference4:</label>
                                <select class="form-select" name="preference4" style="z-index: 100;">
                                                                   <?php
include('connect.php');
...
?>  
                                ...
                                <div class="mb-3"></div>
                                <div class="mb-3"></div>
                                <div><button class="btn btn-primary d-block w-100" type="submit">Submit Topic</button></div>
                            </form>
                        </div>
                    </div>
                </div>
